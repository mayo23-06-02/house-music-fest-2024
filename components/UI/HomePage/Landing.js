...
function Landing() {
    ...
    return (
        <div className={'flex relative h-[1000px] justify-center xl:h-full px-8 space-y-6 xl:space-y-0 xl:py-0 pt-12 xl:px-0'}>
            ...
            <div className={'absolute xl:left-[10%] 2xl:left-[18%] px-8  2xl:top-[25%] 2xl:space-x-16 xl:top-[15%] xl:px-16  grid xl:grid-cols-2 grid-rows-2 grid-flow-col rever xl:grid-flow-row'}>
